...
- **Home** — log a catch, backfill a past catch, plan a day, Calendar Log, and Spots. A new log is **empty** (no sample trips). Buddy linking and optional **Load sample catches** sit under **More**. No homepage catch-count stats.
