...
- **Home** — log a catch, backfill a past catch, plan the next few days, Calendar Log, and Spots. A new journal is **empty** (no sample lakes). Buddy linking and optional **Load sample catches** sit under **More**. No homepage catch-count stats.
