    ...
    <div className="space-y-4">
      <div className="page-intro">
        ...
        <p className="text-sm text-ink-muted">
          Take a photo. Pick a saltwater species — tap a name or type one — or save and add it
          later. A live photo uses the location you allowed at sign-in. Pick or name the area, save.
        </p>
