...
function FishMark() {
  return (
    <svg viewBox="0 0 32 32" className="h-full w-full p-1.5 text-teal" fill="currentColor">
...
function BaitMark() {
  return (
    <svg viewBox="0 0 32 32" className="h-full w-full p-1.5 text-copper" fill="currentColor">
