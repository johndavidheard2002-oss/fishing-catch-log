...
const SEED: CatchInput[] = [
  ...
  },
  {
    ...
    caughtAt: "2025-07-12T07:15:00-05:00",
    timeOfDay: "dawn",
    season: "summer",
    bait: "Soft jerkbait",
    waterClarity: "stained",
    notes: "Same day, different water: dawn at Pace Bend, then the main-lake point that afternoon.",
  },
  {
    photoPath: "/seed/largemouth.svg",
    species: "Largemouth Bass",
  ...
  },
  {
    ...
    tide: "incoming",
    tideHeightFt: 1.4,
    tideDetail: "High 8:40 PM 2.1 ft · Low 2:15 AM 0.3 ft",
    waterClarity: "stained",
  ...
  },
  {
    ...
    tide: "high",
    tideHeightFt: 2.0,
    tideDetail: "High 7:55 PM 2.2 ft · Low 1:50 AM 0.4 ft",
    waterClarity: "stained",
  ...
  },
  {
    ...
    tide: "outgoing",
    tideHeightFt: 0.8,
    tideDetail: "Low 8:10 AM 0.4 ft · High 2:20 PM 1.9 ft",
    waterClarity: "murky",
  ...
  for (const item of SEED) {
    ...
    db.insert(catches)
      .values({
        ...
        bait: item.bait ?? null,
        tide: item.tide ?? null,
        tideHeightFt: item.tideHeightFt ?? null,
        tideDetail: item.tideDetail ?? null,
