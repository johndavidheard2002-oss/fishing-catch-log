...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Pick a spot to view tides and weather.",
      ...
      "On a catch, tap Plan between Share and Delete, then pick the day.",
      "Tap a match to open that trip’s photo and map.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Pick a species, or save and add it later. No camera on Backfill.",
